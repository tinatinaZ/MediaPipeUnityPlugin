...
namespace HandLandmarkInterface
{
    public class HandLandmark : MonoBehaviour
    {
        ...
        public HandLandmarkType LandmarkType;
        public Transform CharacterHandIKAnchor;
        ...
        private HandDepthCalibrator depthCalibrator = new HandDepthCalibrator(-0.0719f, 0.439f);
        private HandTransformLink[] transformLinkers;

        private void Awake()
        {
            transformLinkers = this.transform.GetComponentsInChildren<HandTransformLink>();
        }
        ...
        public void SyncCharacterHand()
        {
            if (CharacterHandIKAnchor == null)
                return;

            this.transform.position = CharacterHandIKAnchor.position;
            
            var wristTransform = LandmarkObjects[0].transform;
            CharacterHandIKAnchor.localRotation = wristTransform.localRotation;
        }
    }
